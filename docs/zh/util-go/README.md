...
[util.go](https://github.com/mhxw/ethereum-development-with-go-book/blob/main/code/util/util.go)
...
test file: [util_test.go](https://github.com/mhxw/ethereum-development-with-go-book/blob/main/code/util/util_test.go)
